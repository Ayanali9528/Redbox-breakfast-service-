...
const plans: Plan[] = [
  {
    ...
    price: "₹147",
    unit: "for 3 boxes",
    perks: ["Double Unit Box daily", "Pick any 3 menu items", "Free first delivery", "Extra 10% off for new users"],
    badge: "New User -10%",
    variant: "trial",
  },
  {
    ...
    price: "₹329",
    unit: "for 7 boxes",
    perks: ["Double Unit Box daily", "Rotate 7 menu items", "Skip-a-day flexibility", "Priority morning slot"],
    popular: true,
    badge: "Most Popular",
    variant: "weekly",
  },
  {
    ...
    price: "₹1,199",
    unit: "for 30 boxes",
    perks: ["Double Unit Box daily", "Full menu access", "Free Sunday special", "Dedicated WhatsApp support"],
    badge: "Save ₹481",
    variant: "monthly",
  },
];
