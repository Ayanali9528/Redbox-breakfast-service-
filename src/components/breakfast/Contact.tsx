  ...
  <section id="contact" className="py-20 lg:py-28 bg-fresh text-secondary-foreground">
    <div className="container grid lg:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <a
          href="https://wa.me/919999999999?text=Hi%20SunriseBites%2C%20I%27d%20like%20to%20start%20a%20breakfast%20plan."
          target="_blank"
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {[
          ...
          { icon: Mail, label: "Email", value: "hello@sunrisebites.in" },
          { icon: MapPin, label: "Serving", value: "Koramangala, HSR, Indiranagar" },
          { icon: MessageCircle, label: "WhatsApp", value: "9 AM – 9 PM, Mon–Sun" },
